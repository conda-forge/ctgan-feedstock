...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ctgan-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14599&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ctgan-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ctgan` can be installed with:

```
conda install ctgan
```

It is possible to list all of the versions of `ctgan` available on your platform with:
